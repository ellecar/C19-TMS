                ...
                <div class="container-fluid"><img data-bs-hover-animate="tada" src="assets/img/carigara.png" style="margin-left: 5px;margin-top: 1px;height: 59px;width: 64px;"><a class="navbar-brand" href="index.php" style="margin-left: 13px;">CARIGARA COVID-19 TRACKING AND MONITORING SYSTEM</a>
                    <div class="collapse navbar-collapse" id="navcol-1">
                        <ul class="nav navbar-nav">
                            <li class="nav-item" role="presentation"><a class="nav-link" href="#footer-section" target="_parent">CONTACT US</a></li>
                        </ul>
                        <form class="form-inline mr-auto" target="_self">
                        </form><span class="navbar-text"> <a class="login" href="login.php">Log In</a></span><a class="btn btn-light action-button" role="button" href="signup.php">Sign Up</a></div>
                </div>
            </nav>